...
import { ContentSectionForm, SuratPerintah, SuratProps } from '@/types/surat';
        ...
        <View style={{ position: 'relative' }}>
          ...
          <View style={{ ...styles.column, gap: 20 }}>
            ...
            <View style={{ ...styles.row, gap: 18 }}>
              ...
              >
                {data.perihal ||
                  'Sorot dan klik bagian ini untuk menampilkan teks editor di sebelah kanan halaman'}
              </Text>
            </View>
          </View>
        </View>
              ...
              {data.penerima?.map((option, i) => (
                ...
                >
                  ...
                  <View style={{ ...styles.column }}>
                    ...
                    <View style={{ ...styles.row, gap: 6 }}>
                      <Text style={{ ...styles.text, width: 140 }}>
                        Pangkat/golongan
                      </Text>
                      <Text style={styles.text}>:</Text>
                      <Text
